...
import Minor.J3.Client.Point;
import Minor.J3.DS.Direction;
import Minor.J3.DS.Compare2D;
import Minor.J3.DS.prQuadTree;
import Minor.J3.DS.Lewis;
      ...
      sfile.close();
		...
		try {
			try {
			   ...
			   Log.write("Exception caught while testing tree initialization: " + e.getMessage() + "\n");
			...
			try {
			   ...
			   Log.write("Exception caught while testing insertion: " + e.getMessage() + "\n");
			   Log.write("Aborting remaining tests.\n");
			   Log.close();
			   return;
			}
			...
			try {
			   ...
			   Log.write("Exception caught while testing region search: " + e.getMessage() + "\n");
			}
			...
			try {
			   ...
			   Log.write("Exception caught while testing deletion: " + e.getMessage() + "\n");
			}
		} 
		catch (Exception e) {
